...
class SMSModuleController extends BaseController
{
    ...
    public function update(SMSModuleUpdateRequest $request, SettingService $settingService): RedirectResponse
    {
        ...
        if ($request['status'] == 1) {
            foreach (['releans', 'twilio', 'nexmo', '2factor', 'playmobile', 'msg91', 'hubtel', 'paradox', 'signal_wire', '019_sms', 'viatech', 'global_sms', 'akandit_sms', 'sms_to', 'alphanet_sms',] as $gateway) {
