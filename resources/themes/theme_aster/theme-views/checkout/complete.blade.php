                        ...
                        <div class="col-xl-6 col-md-10">
                            <div class="text-center d-flex flex-column align-items-center gap-3">
                                ...
                                <div class="d-flex flex-wrap justify-content-center gap-3">
                                    <a href="{{route('home')}}" class="btn btn-outline-primary bg-primary-light border-transparent text-non-capitalize">{{ translate('continue_shopping') }}</a>
                                    <a href="{{ route('track-order.index') }}" class="btn btn-primary text-non-capitalize">{{ translate('track_order') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
