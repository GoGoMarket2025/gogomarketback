...
<div class="d-flex flex-column justify-content-center align-items-center gap-3 mt-5">
    ...
    <button type="button" class="btn btn-primary w-auto min-w-180 text-non-capitalize" data-bs-toggle="modal" data-bs-target="#loginModal">{{translate('open_support_ticket')}}</button>
</div>
