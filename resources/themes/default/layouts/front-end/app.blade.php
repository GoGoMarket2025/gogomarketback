    ...
    <div class="__floating-btn">
        ...
        @if(isset($whatsapp['status']) && $whatsapp['status'] == 1 )
            <div class="wa-widget-send-button">
                <a href="https://t.me/{{ $whatsapp['phone'] }}" target="_blank">
                    <img src="{{theme_asset(path: 'public/assets/front-end/img/telegram.svg')}}" class="wa-messenger-svg-whatsapp wh-svg-icon" alt="{{ translate('Chat_with_us_on_WhatsApp') }}">
                </a>
            </div>
        @endif
    </div>
