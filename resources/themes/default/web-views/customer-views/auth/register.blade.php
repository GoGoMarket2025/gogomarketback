                                ...
                                <div class="rtl">
                                    <label class="custom-control custom-checkbox m-0 d-flex">
                                        ...
                                        <span class="custom-control-label">
                                            ...
                                            <a class="font-size-sm text-primary text-force-underline" target="_blank" href="{{ route('business-page.view', ['slug' => 'terms-and-conditions']) }}">{{ translate('terms_and_condition') }}</a>
                                        </span>
                                    </label>
                                </div>
                            </div>
