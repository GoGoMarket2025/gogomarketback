                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div
                                                        ...
                                                        @foreach($shippingAddresses as $key => $address)
                                                            <div
                                                                class="dropdown-item select_shipping_address {{$key == 0 ? 'active' : ''}}"
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       {{$shippingAddresses->count()==0?'required':''}} id="name">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="tel"
                                                                       ...
                                                                       id="phone" {{$shippingAddresses->count()==0?'required':''}}>
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="email" class="form-control"
                                                                           name="email"
                                                                           id="email" {{$shippingAddresses->count()==0?'required':''}}>
                                                                </div>
                                                            </div>
                                                        @endif
                                                        <div class="col-12">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                @if($zip_restrict_status == 1)
                                                                    <select name="zip" class="form-control selectpicker"
                                                                            ...
                                                                            id="select2-zip-container" required>
                                                                ...
                                                                @else
                                                                    <input type="text" class="form-control"
                                                                           name="zip"
                                                                           id="zip" {{$shippingAddresses->count()==0?'required':''}}>
                                                                @endif
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group mb-1">
                                                                ...
                                                                <textarea class="form-control" id="address" type="text"
                                                                          name="address" {{$shippingAddresses->count()==0?'required':''}}></textarea>
                                                                <span
                            ...
                            @if(!$physical_product_view)
                                <div class="mb-3 alert--info">
                                    <div class="d-flex align-items-center gap-2">
                                        <img class="mb-1"
                                             src="{{ theme_asset('public/assets/front-end/img/icons/info-light.svg') }}"
                                             alt="Info">
                                                    ...
                                                    <div class="">
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                           ...
                                                                           id="billing_contact_person_name" {{$billingAddresses->count()==0?'required':''}}>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                               ...
                                                                               id {{$billingAddresses->count()==0?'required':''}}>
                                                                    </div>
                                                                </div>
                                                            @endif
                                                            <div class="col-12">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="exampleInputEmail1">{{ translate('city')}}
                                                                        <span
                                                                            class="text-danger">*</span></label>
                                                                    <input type="text" class="form-control"
                                                                           id="billing_city"
                                                        ...
                                                        <div class="form-group mb-1">
                                                            ...
                                                            <textarea class="form-control" id="billing_address"
                                                                      ...
                                                                      id="billing_address" {{$billingAddresses->count()==0?'required':''}}></textarea>
