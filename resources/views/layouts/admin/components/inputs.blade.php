    ...
    <div class="card-body">
        ...
        <div class="row g-4 mb-5">
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="">
                    <h2 class="text-primary text-uppercase mb-3">Input Field/Switch Outside (Controllable)</h2>
                    <div class="border border-dashed border-primary rounded p-3">
                        <div class="form-group">
                            <div class="d-flex justify-content-between align-items-center gap-3 mb-2">
                                ...
                                <label class="switcher">
                                    <input type="checkbox" class="switcher_input switcher_input_controllable"
                                        value="" checked="" id="" name="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control warning"
                                placeholder="Type your user name" value="Jhon Doe">
                        </div>
                        <div class="form-group">
                            <div class="d-flex justify-content-between align-items-center gap-3 mb-2">
                                <label class="form-label mb-0" for="">User Name</label>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="">
                    <h2 class="text-primary text-uppercase mb-3">Input Field/Switch Outside</h2>
                    <div class="border border-dashed border-primary rounded p-3">
                        <div class="form-group">
                            <div class="d-flex justify-content-between align-items-center gap-3 mb-2">
                                <label class="form-label mb-0" for="">User Name</label>
                                <label class="switcher">
                                    <input type="checkbox" class="switcher_input" value=""
                                        checked="" id="" name="">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="">
                    <h2 class="text-primary text-uppercase mb-3">Input Field/Plain Text</h2>
                    <div class="border border-dashed border-primary rounded p-3">
                        <div class="form-group">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="">
                    <h2 class="text-primary text-uppercase mb-3">Input Field/Teaxtarea</h2>
                    <div class="border border-dashed border-primary rounded p-3">
                        <div class="form-group">
                            <div class="d-flex justify-content-between align-items-center gap-3 mb-2">
                                <label class="form-label" for="">User Name
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="">
                    <h2 class="text-primary text-uppercase mb-3">Input Field/Selection</h2>
                    <div class="border border-dashed border-primary rounded p-3">
                        <div class="form-group">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="">
                    <h2 class="text-primary text-uppercase mb-3">Input Field/Country picker</h2>
                    <div class="border border-dashed border-primary rounded p-3">
                        <div class="form-group">
                            <label class="form-label" for="">User Name
                                <span class="text-danger">*</span>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="">
                    <h2 class="text-primary text-uppercase mb-3">Input Field/Password</h2>
                    <div class="border border-dashed border-primary rounded p-3">
                        <div class="form-group">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="">
                    <h2 class="text-primary text-uppercase mb-3">Input Field/Search</h2>
                    <div class="border border-dashed border-primary rounded p-3">
                        <div class="form-group">
                            <div class="input-group">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="">
                    <h2 class="text-primary text-uppercase mb-3">Daterange picker</h2>
                    <div class="border border-dashed border-primary rounded p-3">
                        <div class="form-group">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="">
                    <h2 class="text-primary text-uppercase mb-3">Input Field/Switch Inside</h2>
                    <div class="border border-dashed border-primary rounded p-3">
                        <div class="form-group">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="">
                    <h2 class="text-primary text-uppercase mb-3">Input Field/Radio/Checkbox</h2>
                    <div class="border border-dashed border-primary rounded p-3">
                        {{-- Radio --}}
                        <div class="form-group">
                            ...
                            <div
                                class="min-h-40 d-flex align-items-center gap-4 border rounded mb-2 px-3 py-1">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="">
                    <h2 class="text-primary text-uppercase mb-3">Input Field/Selection & Type</h2>
                    <div class="border border-dashed border-primary rounded p-3">
                        <div class="form-group">
                            <label class="form-label" for="">Selection</label>
                            <div class="input-group">
                    ...
                    <div class="border border-dashed border-primary rounded p-3">
                        <div class="d-flex gap-4 align-items-center justify-content-around">
                            ...
                            <label class="switcher switcher-sm">
                                <input type="checkbox" class="switcher_input" value="" checked=""
                                    id="" name="">
                                <span class="switcher_control"></span>
                            </label>
                            <label class="switcher switcher-sm">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="">
                    <h2 class="text-primary text-uppercase mb-3">Radio / Checkbox</h2>
                    <div class="d-flex gap-4">
                        <div class="border border-dashed border-primary rounded p-3">
                            <div class="d-flex gap-4 flex-column align-items-center">
                                {{-- small radio --}}
                                <input class="form-check-input radio--input" type="radio" name=""
                                    id="" value="">
            ...
            <div class="col-lg-6">
                <div class="">
                    <h2 class="text-primary text-uppercase mb-3">Input group with text url field</h2>
                    <div class="border border-dashed border-primary rounded p-3">
                        <div>
                    ...
                    <div class="form-group">
                        <div class="mb-3 d-flex gap-3 flex-wrap justify-content-between align-items-center">
                            <label class="form-label mb-0" for="">Select Business Model
                                <span class="tooltip-icon" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Select Business Model" data-bs-title="Select Business Model">
                                    <i class="fi fi-sr-info"></i>
                                </span>
                            </label>
                            ...
                            <div class="row g-4">
                                <div class="col-xl-6 col-md-6">
                                    <div class="form-check d-flex gap-3">
                                        <input class="form-check-input radio--input radio--input_lg" type="radio" name="select_Business_model" id="" value="">
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="form-check d-flex gap-3">
                                        <input class="form-check-input radio--input radio--input_lg" type="radio" value="phone" name="select_Business_model" id="" checked="">
                                        <div class="flex-grow-1">
                                            <label for="verification_by_phone" class="form-label text-dark fw-semibold mb-1">
                                                Firebase OTP
                                            </label>
                                            <p class="fs-12 mb-3">
                                                Setup necessary <a href="#" class="fw-semibold text-decoration-underline">Firebase Configurations</a>.
                                            </p>
            ...
            <div class="col-lg-6">
                <h3 class="text-primary">Show/hide div with View button</h3>
                <div class="card">
                    <div class="card-body">
                        <div class="view-details-container">
                            <div class="d-flex justify-content-between align-items-center gap-3">
                                ...
                                <div class="d-flex gap-2">
                                     <a href="javascript:" class="fs-12 fw-semibold d-flex align-items-end view-btn">View <i class="fi fi-rr-arrow-small-down fs-16 trans3"></i></a>
                                     <label class="switcher">
                                        <input class="switcher_input toggle-switch-message" type="checkbox" value="1"
                                               id="whatsapp-id" name="status" checked
                            ...
                            <div class="d--none view-details mt-3 mt-sm-4">
                                <div class="bg-info bg-opacity-10 fs-12 px-12 py-10 text-dark rounded d-flex gap-2 align-items-center mb-3">
                                    ...
                                    <span>
                                        Your country code are already selected based on your Business Country that you selected in <a href="#" class="fw-semibold text-decoration-underline">Business Information</a> page.
                                    </span>
                                </div>
                                <div class="p-12 p-sm-20 bg-section rounded">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" id="phone" name="phone" class="form-control"
                                        value="" placeholder="{{translate('Type your number')}}">
                                    </div>
                                    <div class="d-flex justify-content-end flex-wrap gap-3">
                                        <button type="reset" class="btn btn-secondary w-120 px-4">{{translate('reset')}}</button>
                                        <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                                class="btn btn-primary w-120 px-4 {{env('APP_MODE')!= 'demo'? '' : 'call-demo'}}"
