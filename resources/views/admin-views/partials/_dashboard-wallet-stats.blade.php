<div class="col-lg-4">
    <div class="card border h-100 d-flex justify-content-center align-items-center">
        <div class="card-body d-flex flex-column gap-10 align-items-center justify-content-center">
            ...
            <div class="text-non-capitalize fs-12 mb-30">
            ...
            <div class="card border card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-non-capitalize mb-0 fs-12">{{translate('commission_earned')}}</div>
                    </div>
                    <div>
            ...
            <div class="card border card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-non-capitalize mb-0 fs-12">{{translate('delivery_charge_earned')}}</div>
                    </div>
                    <div>
            ...
            <div class="card border card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-non-capitalize mb-0 fs-12">{{translate('total_tax_collected')}}</div>
                    </div>
                    <div>
            ...
            <div class="card border card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-non-capitalize mb-0 fs-12">{{translate('pending_amount')}}</div>
                    </div>
                    <div>
