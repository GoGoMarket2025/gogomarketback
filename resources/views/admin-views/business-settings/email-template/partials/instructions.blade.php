                        ...
                        <div class="swiper-slide px-3">
                            <div class="d-flex flex-column align-items-center gap-2">
                                <img width="80" class="mb-3"
                                     ...
                                     loading="lazy" alt="">
                                <h4 class="lh-md mb-3 text-non-capitalize">{{translate('input_a_title')}}</h4>
                        ...
                        <div class="swiper-slide px-3">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                <img width="80" class="mb-3"
                                     ...
                                     loading="lazy" alt="">
                                <h4 class="lh-md mb-3 text-non-capitalize">{{translate('add_button_&_link')}}</h4>
                        ...
                        <div class="swiper-slide px-3">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                <img width="80" class="mb-3"
                                     ...
                                     loading="lazy" alt="">
                                <h4 class="lh-md mb-3 text-non-capitalize">{{translate('choose_a_icon_/_banner_image')}}</h4>
                        ...
                        <div class="swiper-slide px-3">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                <img width="80" class="mb-3"
                                     ...
                                     loading="lazy" alt="">
                                <h4 class="lh-md mb-3 text-non-capitalize">{{translate('select_footer_content')}}</h4>
                        ...
                        <div class="swiper-slide px-3">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                <img width="80" class="mb-3"
                                     ...
                                     loading="lazy" alt="">
                                <h4 class="lh-md mb-3 text-non-capitalize">{{translate('create_a_copyright_notice')}}</h4>
                                <p class="text-center">
                        ...
                        <div class="swiper-slide px-3">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                <img width="80" class="mb-3"
                                     ...
                                     loading="lazy" alt="">
                                <h4 class="lh-md mb-3 text-non-capitalize">{{translate('save_and_publish')}}</h4>
