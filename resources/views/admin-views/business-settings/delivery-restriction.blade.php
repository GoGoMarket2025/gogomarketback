                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column gap-20">
                            <div class="d-flex justify-content-between align-items-start gap-3 user-select-none">
                                ...
                                <form action="{{ route('admin.business-settings.delivery-restriction.country-restriction-status-change') }}" method="post" id="delivery-available-country-status-form" class="no-reload-form">
                                    @csrf
